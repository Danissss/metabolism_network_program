...
public class FunctionalGroup {
	 ...
	 * @throws Exception
	 */
	public static IAtomContainer add_ugt(IAtomContainer mole,  String enzyme_name,int som_site) throws Exception {
...
//				System.out.println(atoms.getCharge());
	...
	public static void main(String[] args) throws Exception {
		...
		IAtomContainer ugt = add_ugt(mole_no_h,"UGT",14); // 16 but minus -1  = 15
